...
<link rel="stylesheet" type="text/css" href="/shangjd/Public/admin/css/style.css" />
<style>
body{height:100%;background:#16a085;overflow:hidden;}
canvas{z-index:-1;position:absolute;}
</style>
<script src="/shangjd/Public/admin/js/jquery-1.8.3.min.js"></script>
<script src="/shangjd/Public/admin/js/verificationNumbers.js"></script>
<script src="/shangjd/Public/admin/js/Particleground.js"></script>
<script src="/shangjd/Public/admin/layer/layer.js"></script>
<script>
